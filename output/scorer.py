...
if __name__ == '__main__':
    ...
    try:
        ...
        gold_df = pd.read_csv(gold_filename)
        test_df = pd.read_csv(test_filename)
        print("ACCURACY: {:.4f}".format(float(accuracy_score(gold_df["Stance"], test_df["Stance"]))))
        print("PRECISION: {:.4f}".format(float(precision_score(gold_df["Stance"], test_df["Stance"], average="weighted"))))
        print("F1 SCORE: {:.4f}".format(float(f1_score(gold_df["Stance"], test_df["Stance"], average="weighted"))))
